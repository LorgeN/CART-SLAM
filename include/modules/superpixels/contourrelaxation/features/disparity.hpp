 ...
 * @brief Feature of two independently Gaussian-distributed channels, intended for use with horizontal/vertical disparity-derivative images
 */
class DisparityFeature : public AGaussianFeature {
   private:
    typedef int16_t TColorData;  ///< the type of the used image channels
   ...
   public:
     ...
     */
    void setData(cv::Mat const& channel1, cv::Mat const& channel2);
     ...
     */
    void initializeStatistics(cv::Mat const& labelImage) override;
